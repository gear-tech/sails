...
impl<'a, 'ast> Visitor<'ast> for RootGenerator<'a> {
    ...
    fn visit_service(&mut self, service: &'ast Service) {
        ...
        self.traits_tokens.extend(service_gen.tokens);
        ...
        self.tokens.extend(client_gen.tokens);
    ...
    fn visit_type(&mut self, t: &'ast Type) {
        ...
        self.tokens.extend(type_gen.tokens);
    }
}
...
impl<'ast> Visitor<'ast> for DecodeReplyGenerator {
    ...
    fn visit_service_func(&mut self, func: &'ast ServiceFunc) {
        let allow_rule = self
            .is_unit
            .then(|| "#[allow(clippy::let_unit_value)]")
            .unwrap_or_default();
