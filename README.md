...
When it comes to TypeScript `sails-js` lilbrary can be used to interact with the program. Check out `sails-js` documentation [here](js/README.md) for more details.
