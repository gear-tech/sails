...
pub mod rmrk_catalog {
    ...
    impl sails_rs::client::Identifiable for RmrkCatalogImpl {
        const INTERFACE_ID: sails_rs::InterfaceId =
            sails_rs::InterfaceId::from_bytes_8([55, 233, 20, 71, 187, 19, 237, 60]);
    }
    ...
    pub mod io {
        use super::*;
        sails_rs::io_struct_impl!(AddEquippables (part_id: u32, collection_ids: Vec<ActorId>) -> super::Result<(u32, Vec<ActorId>, ), super::Error, >, 0, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
        sails_rs::io_struct_impl!(AddParts (parts: Vec<(u32, super::Part, )>) -> super::Result<Vec<(u32, super::Part, )>, super::Error, >, 1, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
        sails_rs::io_struct_impl!(RemoveEquippable (part_id: u32, collection_id: ActorId) -> super::Result<(u32, ActorId, ), super::Error, >, 2, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
        sails_rs::io_struct_impl!(RemoveParts (part_ids: Vec<u32>) -> super::Result<Vec<u32>, super::Error, >, 3, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
        sails_rs::io_struct_impl!(ResetEquippables (part_id: u32) -> super::Result<(), super::Error, >, 4, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
        sails_rs::io_struct_impl!(SetEquippablesToAll (part_id: u32) -> super::Result<(), super::Error, >, 5, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
        sails_rs::io_struct_impl!(Equippable (part_id: u32, collection_id: ActorId) -> super::Result<bool, super::Error, >, 6, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
        sails_rs::io_struct_impl!(Part (part_id: u32) -> super::Option<super::Part, >, 7, <super::RmrkCatalogImpl as sails_rs::client::Identifiable>::INTERFACE_ID, throws false);
    }
