...
pub mod rmrk_catalog {
    ...
    pub mod io {
        use super::*;
        sails_rs::io_struct_impl!(AddEquippables (part_id: u32, collection_ids: super::Vec<super::ActorId>) -> Result<(u32, super::Vec<super::ActorId>), super::Error>);
        sails_rs::io_struct_impl!(AddParts (parts: super::BTreeMap<u32, super::Part>) -> Result<super::BTreeMap<u32, super::Part>, super::Error>);
        sails_rs::io_struct_impl!(RemoveEquippable (part_id: u32, collection_id: super::ActorId) -> Result<(u32, super::ActorId), super::Error>);
        sails_rs::io_struct_impl!(RemoveParts (part_ids: super::Vec<u32>) -> Result<super::Vec<u32>, super::Error>);
        ...
        sails_rs::io_struct_impl!(Equippable (part_id: u32, collection_id: super::ActorId) -> Result<bool, super::Error>);
