...
pub mod mockall {
    ...
    mock! { pub PingPong {} #[allow(refining_impl_trait)] #[allow(clippy::type_complexity)] impl ping_pong::PingPong for PingPong { type Env = MockEnv; fn ping (&mut self, input: String) -> PendingCall<MockEnv, ping_pong::io::Ping>; } }
    mock! { pub Counter {} #[allow(refining_impl_trait)] #[allow(clippy::type_complexity)] impl counter::Counter for Counter { type Env = MockEnv; fn add (&mut self, value: u32) -> PendingCall<MockEnv, counter::io::Add>;fn sub (&mut self, value: u32) -> PendingCall<MockEnv, counter::io::Sub>;fn value (& self, ) -> PendingCall<MockEnv, counter::io::Value>; } }
    mock! { pub Dog {} #[allow(refining_impl_trait)] #[allow(clippy::type_complexity)] impl dog::Dog for Dog { type Env = MockEnv; fn make_sound (&mut self, ) -> PendingCall<MockEnv, dog::io::MakeSound>;fn walk (&mut self, dx: i32, dy: i32) -> PendingCall<MockEnv, dog::io::Walk>;fn avg_weight (& self, ) -> PendingCall<MockEnv, dog::io::AvgWeight>;fn position (& self, ) -> PendingCall<MockEnv, dog::io::Position>; } }
    mock! { pub References {} #[allow(refining_impl_trait)] #[allow(clippy::type_complexity)] impl references::References for References { type Env = MockEnv; fn add (&mut self, v: u32) -> PendingCall<MockEnv, references::io::Add>;fn add_byte (&mut self, byte: u8) -> PendingCall<MockEnv, references::io::AddByte>;fn guess_num (&mut self, number: u8) -> PendingCall<MockEnv, references::io::GuessNum>;fn incr (&mut self, ) -> PendingCall<MockEnv, references::io::Incr>;fn set_num (&mut self, number: u8) -> PendingCall<MockEnv, references::io::SetNum>;fn baked (& self, ) -> PendingCall<MockEnv, references::io::Baked>;fn last_byte (& self, ) -> PendingCall<MockEnv, references::io::LastByte>;fn message (& self, ) -> PendingCall<MockEnv, references::io::Message>; } }
    mock! { pub ThisThat {} #[allow(refining_impl_trait)] #[allow(clippy::type_complexity)] impl this_that::ThisThat for ThisThat { type Env = MockEnv; fn do_that (&mut self, param: DoThatParam) -> PendingCall<MockEnv, this_that::io::DoThat>;fn do_this (&mut self, p1: u32, p2: String, p3: (Option<H160>,NonZeroU8,), p4: TupleStruct) -> PendingCall<MockEnv, this_that::io::DoThis>;fn noop (&mut self, ) -> PendingCall<MockEnv, this_that::io::Noop>;fn that (& self, ) -> PendingCall<MockEnv, this_that::io::That>;fn this (& self, ) -> PendingCall<MockEnv, this_that::io::This>; } }
    mock! { pub ValueFee {} #[allow(refining_impl_trait)] #[allow(clippy::type_complexity)] impl value_fee::ValueFee for ValueFee { type Env = MockEnv; fn do_something_and_take_fee (&mut self, ) -> PendingCall<MockEnv, value_fee::io::DoSomethingAndTakeFee>; } }
}
