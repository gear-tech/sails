...
pub mod this_that {
    ...
    pub mod io {
        use super::*;
        sails_rs::io_struct_impl!(DoThat (param: super::DoThatParam) -> Result<(super::ActorId, super::NonZeroU32, super::ManyVariantsReply), (String,)>);
        sails_rs::io_struct_impl!(DoThis (p1: u32, p2: String, p3: (Option<H160>, super::NonZeroU8), p4: super::TupleStruct) -> (String, u32));
