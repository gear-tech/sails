...
pub mod mockall {
    ...
    mock! { pub ValueFee<A> {} #[allow(refining_impl_trait)] #[allow(clippy::type_complexity)] impl<A> traits::ValueFee for ValueFee<A> { type Args = A; fn do_something_and_take_fee (&mut self, ) -> MockCall<A, bool>;fn take_fee_and_return_nothing (&mut self, ) -> MockCall<A, ()>; } }
}
