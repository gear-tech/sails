   ...
   Compiling gear-stack-buffer v1.8.1
   Compiling syn v1.0.109
   Compiling gear-dlmalloc v0.2.0
    Checking byte-slice-cast v1.2.2
    Checking arrayvec v0.7.6
    Checking cfg-if v1.0.0
   Compiling memchr v2.7.4
    Checking static_assertions v1.1.0
   Compiling wasmparser v0.230.0
   Compiling autocfg v1.4.0
   Compiling wasm-encoder v0.230.0
   ...
   Compiling thiserror-impl v1.0.69
    Checking str-buf v3.0.3
    Checking zerocopy v0.7.35
    Checking futures-task v0.3.31
    Checking pin-utils v0.1.0
   Compiling gear-wasm-builder v1.8.1
    Checking once_cell v1.20.3
    Checking pin-project-lite v0.2.16
    Checking allocator-api2 v0.2.21
   Compiling galloc v1.8.1
   ...
   Compiling gear-wasm-optimizer v1.8.1
   ...
   Compiling sails-macros-core v0.8.1 (/Users/sab-dev/Documents/sails/rs/macros/core)
    Checking primitive-types v0.12.2
    Checking gear-core-errors v1.8.1
    Checking sails-idl-meta v0.8.1 (/Users/sab-dev/Documents/sails/rs/idl-meta)
   Compiling numerated v1.8.1
   Compiling sails-macros v0.8.1 (/Users/sab-dev/Documents/sails/rs/macros)
    Checking gprimitives v1.8.1
    Checking gcore v1.8.1
   Compiling gear-core v1.8.1
   Compiling gstd-codegen v1.8.1
   Compiling gstd v1.8.1
    Checking sails-rs v0.8.1 (/Users/sab-dev/Documents/sails/rs)
    Checking demo-walker v0.1.0 (/Users/sab-dev/Documents/sails/examples/demo/walker)
   Compiling demo v0.1.0 (/Users/sab-dev/Documents/sails/examples/demo/app)
        ...
        impl sails_rs::scale_codec::Encode for CounterEvents {
            ...
            >(&self, __codec_dest_edqy: &mut __CodecOutputEdqy) {
                const _: () = {
                    ...
                    const indices: [(u8, &'static str); 2usize] = [
                        ((0usize) as ::core::primitive::u8, "Added"),
                        ((1usize) as ::core::primitive::u8, "Subtracted"),
                    ];
                    const fn duplicate_info(
                        array: &[(u8, &'static str); 2usize],
                    ) -> (bool, usize, usize) {
                        let len = 2usize;
                        let mut i = 0;
                        while i < len {
    ...
    impl CounterServiceExposure<CounterService<'_>> {
        ...
        pub fn try_handle(
            ...
            if let Ok(request) = counter_service_meta::__AddParams::decode_params(
                ...
                let value = 0u128;
                if sails_rs::prelude::Encode::encoded_size(&result) != 0 {
    ...
    const _: () = {
        ...
        impl sails_rs::scale_codec::Encode for DogEvents {
            ...
            >(&self, __codec_dest_edqy: &mut __CodecOutputEdqy) {
                const _: () = {
                    #[allow(clippy::unnecessary_cast)]
                    const indices: [(u8, &'static str); 1usize] = [
                        ((0usize) as ::core::primitive::u8, "Barked"),
                    ];
                    const fn duplicate_info(
                        array: &[(u8, &'static str); 1usize],
                    ) -> (bool, usize, usize) {
                        let len = 1usize;
                        let mut i = 0;
                        while i < len {
    ...
    const _: () = {
        ...
        impl sails_rs::scale_codec::Decode for ManyVariants {
            fn decode<__CodecInputEdqy: sails_rs::scale_codec::Input>(
                ...
                const _: () = {
                    #[allow(clippy::unnecessary_cast)]
                    const indices: [(u8, &'static str); 6usize] = [
                        ((0usize) as ::core::primitive::u8, "One"),
                        ((1usize) as ::core::primitive::u8, "Two"),
                        ((2usize) as ::core::primitive::u8, "Three"),
                        ((3usize) as ::core::primitive::u8, "Four"),
                        ((4usize) as ::core::primitive::u8, "Five"),
                        ((5usize) as ::core::primitive::u8, "Six"),
                    ];
                    const fn duplicate_info(
                        array: &[(u8, &'static str); 6usize],
                    ) -> (bool, usize, usize) {
                        let len = 6usize;
                        let mut i = 0;
                        while i < len {
        ...
        impl sails_rs::scale_codec::Encode for FeeEvents {
            ...
            >(&self, __codec_dest_edqy: &mut __CodecOutputEdqy) {
                const _: () = {
                    #[allow(clippy::unnecessary_cast)]
                    const indices: [(u8, &'static str); 1usize] = [
                        ((0usize) as ::core::primitive::u8, "Withheld"),
                    ];
                    const fn duplicate_info(
                        array: &[(u8, &'static str); 1usize],
                    ) -> (bool, usize, usize) {
...
impl DemoProgram {
    ...
    fn __counter(&self) -> counter::CounterService {
    ...
    fn __references(&mut self) -> references::ReferenceService {
    ...
    pub fn counter(
        &self,
    ) -> <counter::CounterService as sails_rs::gstd::services::Service>::Exposure {
        let service = self.__counter();
        let exposure = <counter::CounterService as sails_rs::gstd::services::Service>::expose(
            service,
    ...
    pub fn references(
        &mut self,
    ) -> <references::ReferenceService as sails_rs::gstd::services::Service>::Exposure {
        let service = self.__references();
        let exposure = <references::ReferenceService as sails_rs::gstd::services::Service>::expose(
            service,
...
impl sails_rs::meta::ProgramMeta for DemoProgram {
    ...
    const SERVICES: &'static [(&'static str, sails_rs::meta::AnyServiceMetaFn)] = &[
        ...
        ("Counter", sails_rs::meta::AnyServiceMeta::new::<counter::CounterService>),
        ("Dog", sails_rs::meta::AnyServiceMeta::new::<dog::DogService>),
        (
            "References",
            sails_rs::meta::AnyServiceMeta::new::<references::ReferenceService>,
        ),
    ...
    const ASYNC: bool = <ping::PingService as sails_rs::meta::ServiceMeta>::ASYNC
        || <counter::CounterService as sails_rs::meta::ServiceMeta>::ASYNC
        || <dog::DogService as sails_rs::meta::ServiceMeta>::ASYNC
        || <references::ReferenceService as sails_rs::meta::ServiceMeta>::ASYNC
