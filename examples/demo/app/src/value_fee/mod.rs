...
mod tests {
    ...
    fn test_zero_value() {
        ...
        let mut fee_service = FeeService::new(100); // fee = 100
    ...
    fn test_insufficient_value() {
        ...
        let mut fee_service = FeeService::new(200); // fee = 200
    ...
    fn test_fee_taken_with_zero_remaining() {
        // Arrange
        Syscall::with_message_value(100);
        let mut fee_service = FeeService::new(100);
    ...
    fn test_fee_taken_with_remaining_value() {
        ...
        let mut fee_service = FeeService::new(fee);
