...
namespace Substrate.Gear.Api.Generated.Storage
{
    ...
    public sealed class ChildBountiesStorage
    {
        ...
        ///  The description of each child-bounty.
        /// </summary>
        public async Task<Substrate.Gear.Api.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28> ChildBountyDescriptions(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
