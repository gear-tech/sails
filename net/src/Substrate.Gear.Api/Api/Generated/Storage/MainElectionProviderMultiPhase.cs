...
namespace Substrate.Gear.Api.Generated.Storage
{
    ...
    public sealed class ElectionProviderMultiPhaseStorage
    {
        ...
        public ElectionProviderMultiPhaseStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "SignedSubmissionIndices"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Gear.Api.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27)));
        ...
        ///  them one at a time instead of reading and decoding all of them at once.
        /// </summary>
        public async Task<Substrate.Gear.Api.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27> SignedSubmissionIndices(string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SignedSubmissionIndicesParams();
            var result = await _client.GetStorageAsync<Substrate.Gear.Api.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class ElectionProviderMultiPhaseConstants
    {
        ...
        /// </summary>
        public Substrate.Gear.Api.Generated.Model.sp_arithmetic.per_things.Perbill BetterUnsignedThreshold()
        {
            var result = new Substrate.Gear.Api.Generated.Model.sp_arithmetic.per_things.Perbill();
