...
namespace Substrate.Gear.Api.Generated.Model.pallet_staking
{
    ...
    public sealed class Nominations : BaseType
    {
        ...
        /// >> targets
        /// </summary>
        public Substrate.Gear.Api.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13 Targets { get; set; }
        /// <summary>
        /// >> submitted_in
        /// </summary>
        ...
        {
            var start = p;
            Targets = new Substrate.Gear.Api.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13();
