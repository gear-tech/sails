...
namespace Substrate.Gear.Api.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 504 - Composite[pallet_identity.types.RegistrarInfo]
    /// </summary>
    ...
    public sealed class RegistrarInfo : BaseType
    {
        ...
        /// >> account
        /// </summary>
        public Substrate.Gear.Api.Generated.Model.sp_core.crypto.AccountId32 Account { get; set; }
        /// <summary>
        /// >> fee
        /// </summary>
        ...
        {
            var start = p;
            Account = new Substrate.Gear.Api.Generated.Model.sp_core.crypto.AccountId32();
