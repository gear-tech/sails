...
public class DemoClientTests
{
    ...
    public async Task Demo_DefaultConstructor()
    {
        ...
        var expectedProgramId = new ActorId { Value = new Arr32U8 { Value = bytes.ToU8Array() } };
        ...
        var codeId = new CodeId { Value = new Arr32U8 { Value = (new byte[32]).ToU8Array() } };
    ...
    public async Task PingPong_Works()
    {
        ...
        var programId = new ActorId { Value = new Arr32U8 { Value = (new byte[32]).ToU8Array() } };
