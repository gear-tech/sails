                ...
                EnumVariant {
                    ...
                    def: StructDef {
                        fields: vec![
                            ...
                            StructField {
                                name: None,
                                type_decl: Tuple(vec![Primitive(U32), Primitive(U32)]),
                                docs: vec!["Some docs".to_string()],
                                annotations: vec![],
                            },
                        ],
                ...
                EnumVariant {
                    ...
                    def: StructDef {
                        fields: vec![
                            StructField {
                                name: Some("p1".to_string()),
                                type_decl: TypeDecl::option(Named("T1".to_string(), vec![])),
                                docs: vec![],
                                annotations: vec![],
                            },
                            StructField {
