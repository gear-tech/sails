...
pub trait Visitor<'ast> {
    ...
    /// Visits a service item within a program, [ast::ProgramServiceItem].
    /// This is a leaf node.
    ...
    /// Visits a result type declaration, `Result<T, E>`, from [ast::TypeDecl::Result].
