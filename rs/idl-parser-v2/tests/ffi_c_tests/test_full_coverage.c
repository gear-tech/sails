...
static int count_option_type_decl = 0;
static int count_result_type_decl = 0;
static int count_primitive_type = 0;
static int count_user_defined_type = 0;
...
void cb_visit_option_type_decl(const void *context, const TypeDecl *inner_ty) {
  count_option_type_decl++;
  accept_type_decl(inner_ty, context, (const Visitor *)context);
}

void cb_visit_result_type_decl(const void *context, const TypeDecl *ok_node,
                               const TypeDecl *err_node) {
  count_result_type_decl++;
  accept_type_decl(ok_node, context, (const Visitor *)context);
  accept_type_decl(err_node, context, (const Visitor *)context);
}
...
void cb_visit_program_service_item(const void *context,
...
int main() {
  ...
  Visitor full_visitor = {
      ...
      .visit_option_type_decl = cb_visit_option_type_decl,
      .visit_result_type_decl = cb_visit_result_type_decl,
      .visit_primitive_type = cb_visit_primitive_type,
      .visit_user_defined_type = cb_visit_user_defined_type,
  ...
  printf("  option_type_decl: %d\n", count_option_type_decl);
  printf("  result_type_decl: %d\n", count_result_type_decl);
  printf("  primitive_type: %d\n", count_primitive_type);
  printf("  user_defined_type: %d\n", count_user_defined_type);
